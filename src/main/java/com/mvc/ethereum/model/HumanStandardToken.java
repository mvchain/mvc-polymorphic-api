...
public final class HumanStandardToken extends Contract {
    ...
    public TransactionReceipt approveAndCall(Address _spender, Uint256 _value, DynamicBytes _extraData) throws IOException, TransactionException {
    ...
    public static HumanStandardToken deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue, Uint256 _initialAmount, Utf8String _tokenName, Uint8 _decimalUnits, Utf8String _tokenSymbol) throws IOException, TransactionException {
    ...
    public static HumanStandardToken deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger initialWeiValue, Uint256 _initialAmount, Utf8String _tokenName, Uint8 _decimalUnits, Utf8String _tokenSymbol) throws IOException, TransactionException {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(_initialAmount, _tokenName, _decimalUnits, _tokenSymbol));
